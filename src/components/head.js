...
function Head () {
  ...
  const [loginpage, setLoginpagge] = useState(false)
 
  const[emailAddresslog,setEmailaddresslog]=useState("")
  const[passwordlog,setPasswordlog]=useState("")
  const[userNamelog,setUsernameglo]=useState("")
  message.success('login')
  const loged = values => {
    console.log(values)
    let {myusername} = values
    navigate("/login",{state:{myusername}})
  }
  const login=()=>{
    Axios.post("http://localhost",{
      userName:userNamelog,
      password:passwordlog,
      emailAddress:emailAddresslog
    }).then((response)=>{
        ...
        >
          ...
          >
            ...
            <Form.Item
              ...
              name={'myemail'}
            >
              <Input placeholder='Enter your email address'  onChange={(e)=>{setEmailaddresslog(e.target.value)}}/>
            </Form.Item>
            <Form.Item
              rules={[
                {
              ...
              name={'myusername'}
            >
              <Input placeholder='Enter your username'onChange={(e)=>{setUsernameglo(e.target.value)}} />
            </Form.Item>
            <Form.Item
              rules={[
                {
              ...
              name={'mypassword'}
            >
              <Input.Password placeholder='Enter your password'onChange={(e)=>{setPasswordlog(e.target.value)}} />
            </Form.Item>
            <Form.Item
              name='remember'
